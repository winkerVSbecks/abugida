export const ScriptTypes = () => (
  <div className="fn fl-ns w-50-ns">
    <p className="measure lh-copy mt0 mb2">
      An <b>alphabet</b> is a standardized set of basic written symbols or
      graphemes (called letters) that represent the phonemes of certain spoken
      languages.
    </p>
    <p className="measure lh-copy mb4 mt0 i">
      Examples: English, French, Greek, Russian, etc.
    </p>
    ...
    <p className="measure lh-copy mb2">
      ...
      pseudo-alphabet, is a segmental writing system in which consonant-vowel
      sequences are written as units; each unit is based on a consonant letter,
    ...
    <p className="measure lh-copy mb2">
      A <b>logogram</b> or logograph is a written character that represents a
      word or morpheme.
    </p>
    <p className="measure lh-copy mb4 mt0 i">
    ...
    <p className="measure lh-copy mb2">
      In a <b>featural alphabet</b>, the shapes of the symbols (such as letters)
